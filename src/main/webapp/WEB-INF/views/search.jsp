                    ...
                    <ul>
                        <c:forEach items="${pageInfo.list}" var="goods">
                            <li class="data-item-li">
                                <div class="to-big">
                                    <a href="${pageContext.request.contextPath}/detail?goodsid=${goods.goodsid}"> <img src="./shopimage/${goods.imagePaths[0].path}" width="200px" height="200px" alt=""/>
                                    </a>
                                </div>
                                <p class="text-center">
