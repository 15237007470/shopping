            ...
            <div class="sort">
                <div class="sort-channel">
                    <ul class="sort-channel-list list-group">
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=电脑">电脑</a>
                        ...
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=鼠标">鼠标</a>
                            <%--<div class="sort-detail">
                                <dl class="dl-hor">
                                    <dt>
                        ...
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=键盘">键盘</a>
                           <%-- <div class="sort-detail">
                                <dl class="dl-hor">
                                    <dt>
                        ...
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=显卡">显卡</a>
                           <%-- <div class="sort-detail">
                                <dl class="dl-hor">
                                    <dt>
