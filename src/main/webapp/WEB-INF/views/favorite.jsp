...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
    ...
    <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
            ...
            <a class="mdl-navigation__link" href="${pageContext.request.contextPath}/admin/order/sendGoods"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">forum</i>后台管理</a>
            <a class="mdl-navigation__link" href="${pageContext.request.contextPath}/info/list"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">forum</i>我的订单</a>
                            ...
                            <ul>
                                <c:forEach items="${pageInfo.list}" var="goods">
                                    <li class="data-item-li">
                                        <div class="to-big">
                                            <a href="${pageContext.request.contextPath}/detail?goodsid=${goods.goodsid}"> <img src="http://localhost:8080/shop/shopimage/${goods.imagePaths[0].path}" width="200px" height="200px" alt=""/>
                                            </a>
                                        </div>
                                        <p class="text-center">
